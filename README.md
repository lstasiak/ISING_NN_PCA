...
We can see that above critical temperature, the system is in high fluctuations that do not disappear with time. On the other hand, below Tc the system ends up in established state -- approximately all spins take the same sign (are in the same direction). 
___
